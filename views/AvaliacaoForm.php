    ...
    <div class="row mt-4">
      <div class="col-md-6">
        ...
        <form action="<?= $baseUrl ?>/avaliacoes-adm/atualizar" method="post">
          ...
          <textarea class="form-control" name="descricao" id="descricao" placeholder="Descrição do item" required><?= $descricao ?></textarea>
          <br>
          ...
          <input class="form-check-input" value="1" type="checkbox" name="status" id="status" required <?= $status ?>>
          <br>
